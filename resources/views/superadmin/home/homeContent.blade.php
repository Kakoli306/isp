					...
					<header class="card-header bg-primary">
						...
						<div class="widget-profile-info">
							<div class="profile-picture">
								<img src="{{asset('superadmin/')}}/img/%21logged-user.jpg">
							</div>
									...
									<ul class="simple-user-list mb-3">
										<li>
											<figure class="image rounded">
												<img src="{{asset('superadmin/')}}/img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle">
											</figure>
										...
										<li>
											<figure class="image rounded">
												<img src="{{asset('superadmin/')}}/img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle">
											</figure>
										...
										<li>
											<figure class="image rounded">
												<img src="{{asset('superadmin/')}}/img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle">
											</figure>
							...
							<li>
								<div class="tm-box">
									...
									<div class="thumbnail-gallery">
										<a class="img-thumbnail lightbox" href="{{asset('superadmin/')}}/img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
											<img class="img-fluid" width="215" src="{{asset('superadmin/')}}/img/projects/project-4.jpg">
											<span class="zoom">
