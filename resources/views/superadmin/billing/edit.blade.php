            ...
            <div class="card-body">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="{{url('/billing/add/'.$BillingById->id)}}">
                    ...
                    <div class="row" style="padding:10px; font-size: 12px;">
                        ...
                        <div class="col-md-12" style="padding: 5px 0px 15px 0px; float:right; font-size: 12px; text-align: center;">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <form action="{{ route('delete-billing') }}" method="POST">
                                    ...
                                    <a href="{{ route('edit-amount',['id'=>$value->id]) }}" class="btn-outline-info">
                                        Edit</a>
